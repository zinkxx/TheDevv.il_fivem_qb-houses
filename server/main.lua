...
QBCore.Commands.Add("setstash","", {}, false, function(source)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.PlayerData.job.name == "realestate" then
    TriggerClientEvent("qb-houses:client:setLocation", src,"setstash")
else
    TriggerClientEvent('QBCore:Notify', src, Lang:t("error.realestate_only"), "error")
end
end)

QBCore.Commands.Add("setoutift","", {}, false, function(source)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.PlayerData.job.name == "realestate" then
    TriggerClientEvent("qb-houses:client:setLocation", src,"setoutift")
else
    TriggerClientEvent('QBCore:Notify', src, Lang:t("error.realestate_only"), "error")
end
end)
